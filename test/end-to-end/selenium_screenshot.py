...
def make_screenshot(
    selenium_hub_url, desired_capabilities, url, png, timeout_in_seconds
):
    driver = webdriver.Remote(
        command_executor=selenium_hub_url, desired_capabilities=desired_capabilities
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "timeout_in_seconds", type=int, help="keep searching for given id for x seconds"
    )
